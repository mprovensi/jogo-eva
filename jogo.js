// Jogo de personagem que pula obstáculos
...
require('fs').writeFileSync('jogo_pulo.html', html);
console.log('Arquivo jogo_pulo.html gerado. Abra no navegador para jogar!');
